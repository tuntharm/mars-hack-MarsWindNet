...
At that earlier delivery, build-generated outputs were regenerated and dependency manifests were unchanged. The source was preserved locally before editing. The subsequent repository organisation added Git tracking, portable documentation and CFD import commands; see the current status record.
